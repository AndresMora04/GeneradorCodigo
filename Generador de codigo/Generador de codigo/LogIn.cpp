	...
	: QMainWindow(parent)
{
	...
	ui.txtInstructions->setText(
		...
		"- \"crear lista de Estudiantes con 5 elementos llamada estudiantes\"\n"
		...
		"- Siempre debes tener la variable necesaria antes de llamarla.\n"
		"- Evita usar como NOMBRE DE VARIABLE cualquier palabra reservada del lenguaje:\n"
		...
		"- Evita tambien nombres ambiguos o que el parser usa internamente:\n"
		"  y (conjuncion), i (indice de bucles), primer/segundo/.../decimo (ordinales).\n"
		"- Prefiere nombres descriptivos: edad, total, promedio, buscado, encontrado,\n"
		"  contador, acumulador, notas, estudiantes, resultado, cantidad, limite.\n"
	);
